...
urlpatterns = [
    ...
    url(r'^search-availablity/location/', views.SearchAvailablity.as_view(), name='search_availablity_location'),
    url(r'^search-availablity/campground/', views.SearchAvailablity.as_view(), name='search_availablity_campground'),
