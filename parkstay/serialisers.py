...
class CampsiteBookingSerializer(serializers.Serializer):
    ...
    created_by = serializers.IntegerField(default=None, allow_null=True)
...
class ParkEntryRateSerializer(serializers.ModelSerializer):
    class Meta:
        model = ParkEntryRate
        fields = ("id", "period_start", "period_end", "reason", "details", "vehicle","campervan","caravan","trailer", "concession", "motorbike", "editable","gst")
        read_only_fields = ('editable',)
